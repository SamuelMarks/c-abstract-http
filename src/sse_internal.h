...
struct sse_parser_ctx {
    ...
    c_abstract_http_sse_on_event on_event; /**< User callback for completed events */
    c_abstract_http_sse_on_error on_error; /**< User callback for parsing errors */
    c_abstract_http_sse_on_close on_close; /**< User callback for connection closures */
