 ...
 * @brief Autogenerated docstring
 */
int ascii_to_wide(const char *s, wchar_t *ws,
 ...
 * @brief Autogenerated docstring
 */
int wide_to_ascii(const wchar_t *ws, char *s,
                                      size_t buf_cap, size_t *out_len);
 ...
 * @brief Autogenerated docstring
 */
int fopen_error_from(int fopen_error,
 ...
 * @brief Autogenerated docstring
 */
int read_to_file(const char *path, const char *mode,
 ...
 * @brief Autogenerated docstring
 */
int read_from_fh(FILE *fh, char **out_data,
                                     size_t *out_size);
 ...
 * @brief Autogenerated docstring
 */
int mktmpfilegetnameandfile(const char *prefix,
                                                const char *suffix,
                                                const char *mode,
 ...
 * @brief Autogenerated docstring
 */
int walk_directory(const char *path, fs_walk_cb cb,
                                       void *user_data);
