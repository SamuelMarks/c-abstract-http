...
static void test_tls_task_cb(void *arg) { /* LCOV_EXCL_LINE */
  ...
  abstract_http_tls_set(tls_key, &thread_local_val); /* LCOV_EXCL_LINE */
...
TEST test_tls_isolation(void) { /* LCOV_EXCL_LINE */
  ...
  abstract_http_tls_key_delete(tls_key); /* LCOV_EXCL_LINE */
...
TEST test_tls_oom(void) {                                  /* LCOV_EXCL_LINE */
  ...
  abstract_http_tls_key_delete(key); /* LCOV_EXCL_LINE */
...
TEST test_tls_errors(void) {           /* LCOV_EXCL_LINE */
  ...
  abstract_http_tls_key_delete(NULL); /* LCOV_EXCL_LINE */
  PASS();                             /* LCOV_EXCL_LINE */
} /* LCOV_EXCL_LINE */
