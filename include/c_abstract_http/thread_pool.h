 ...
 */
extern c_abstract_http_error_t cdd_mutex_init(struct CddMutex **mutex);
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t cdd_mutex_lock(struct CddMutex *mutex);
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t cdd_mutex_unlock(struct CddMutex *mutex);
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t cdd_cond_init(struct CddCond **cond);
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t cdd_cond_wait(struct CddCond *cond,
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t cdd_cond_signal(struct CddCond *cond);
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t cdd_cond_broadcast(struct CddCond *cond);
 ...
 */
extern c_abstract_http_error_t cdd_thread_pool_init(struct CddThreadPool **pool,
                                                    size_t num_threads);
 ...
 * @return 0 on success, error code on failure.
 */
extern c_abstract_http_error_t cdd_thread_pool_push(struct CddThreadPool *pool,
...
cdd_thread_pool_free(struct CddThreadPool *pool);
