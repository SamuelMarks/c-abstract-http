 ...
 */
extern c_abstract_http_error_t http_loop_init(struct ModalityEventLoop **loop);
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t http_loop_run(struct ModalityEventLoop *loop);
 ...
 */
extern c_abstract_http_error_t http_loop_tick(struct ModalityEventLoop *loop);
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t http_loop_stop(struct ModalityEventLoop *loop);
 ...
 */
extern c_abstract_http_error_t http_loop_add_fd(struct ModalityEventLoop *loop,
                                                int fd, int events,
                                                http_loop_cb cb,
                                                void *user_data);
 ...
 */
extern c_abstract_http_error_t http_loop_mod_fd(struct ModalityEventLoop *loop,
                                                int fd, int events);
 ...
 */
extern c_abstract_http_error_t
http_loop_remove_fd(struct ModalityEventLoop *loop, int fd);
 ...
 * @return 0 on success.
 */
extern c_abstract_http_error_t http_loop_wakeup(struct ModalityEventLoop *loop);
