 ...
 * @brief Autogenerated docstring
 */
int c_cdd_str_starts_with(const char *str,
 ...
 * @brief Autogenerated docstring
 */
int c_cdd_str_equal(const char *a, const char *b,
                                        int *out_b);
 ...
 * @brief Autogenerated docstring
 */
int c_cdd_str_iequal(const char *a, const char *b,
                                         int *out_b);
 ...
 * @brief Autogenerated docstring
 */
int c_cdd_str_after_last(const char *str, int delimiter,
                                             const char **out_s);
